  ...
  >
    ...
    <div class="bg-neutral w-full mx-5 rounded-md flex flex-col gap-10 p-8 max-w-110">
      ...
      <div class="text-center">
        <h2 class="text-primary text-2xl font-medium md:text-3xl">Create Account</h2>
      ...
      <div>
        <!-- Button -->
        <button class="bg-primary text-neutral py-2 rounded-sm w-full mb-2 md:text-xl">Signup</button>
        <!-- Text -->
